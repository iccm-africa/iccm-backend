...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
			<form method="POST" action="{{  action('PostRegistrationController@update', $mail_id) }}" enctype="multipart/form-data">
            ...
            <div class="card mt-3">
                ...
                <div class="card-body">
					<div class="form-group row">
                            ...
                            <div class="col-md-6">
								<input id="share_acco" type="text" class="form-control" name="share_acco" value="{{ $post->share_acco }}" autocomplete="share_acco" autofocus>
								@error('share_acco') 
                ...
                <div class="card-body">
					<div class="form-group row">
                            ...
                            <div class="col-md-6">
								<div class="form-check form-check-inline">
  									<input class="form-check-input @error('traveling') is-invalid @enderror" type="radio" name="traveling" id="traveling" value="car" @if($post->traveling == 'car') checked @endif>
								    <label class="form-check-label" for="traveling">{{ __('Car') }}</label>
								</div>
								<div class="form-check form-check-inline">
  									<input class="form-check-input @error('traveling') is-invalid @enderror" type="radio" name="traveling" id="traveling" value="air" @if($post->traveling == 'air') checked @endif>
								    <label class="form-check-label" for="traveling">{{ __('Air') }}</label>
								</div>
								<div class="form-check form-check-inline">
  									<input class="form-check-input @error('traveling') is-invalid @enderror" type="radio" name="traveling" id="traveling" value="bus" @if($post->traveling == 'bus') checked @endif>
								    <label class="form-check-label" for="traveling">{{ __('Bus') }}</label>
								</div>
								<div class="form-check form-check-inline">
  									<input class="form-check-input @error('traveling') is-invalid @enderror" type="radio" name="traveling" id="traveling" value="other" @if($post->traveling == 'other') checked @endif>
					...
					<div class="form-group row">
                            ...
                            <div class="col-md-6">
								<textarea class="form-control" id="share_travelplans" name="share_travelplans" rows="3">{{ $post->share_travelplans }}</textarea>
						...
						<div class="form-group row">
                            ...
                            <div class="col-md-6">
								@if ($post->ticket_path)
								<a href="{{ route('postregistration.file', $post->ticket_path) }}"><button type="button" class="btn btn-success">Download ticket</button></a><br />
								Change ticket:
								@endif
                ...
                <div class="card-body">
					<div class="form-group row">
						<label for="name" class="col-md-6 col-form-label text-md-left">{{ __('Contact Name') }} *</label>
							<div class="col-md-6">
								<input id="emergency_name" type="text" class="form-control" name="emergency_name" value="{{ $post->emergency_name }}" autocomplete="emergency_name" autofocus>
                     ...
                     <div class="form-group row">
						<label for="emergency_phone" class="col-md-6 col-form-label text-md-left">{{ __('Full international contact phone number:') }} *</label>
							<div class="col-md-6">
								<input id="emergency_phone" type="text" class="form-control" name="emergency_phone" value="{{ $post->emergency_phone }}" autocomplete="emergency_phone" autofocus>
                     ...
                     <div class="form-group row">
						<label for="emergency_country" class="col-md-6 col-form-label text-md-left">{{ __('Contact Country:') }} *</label>
							<div class="col-md-6">
								<input id="emergency_country" type="text" class="form-control" name="emergency_country" value="{{ $post->emergency_country }}" autocomplete="emergency_country" autofocus>
		    ...
		    <div class="card">
                ...
                <div class="card-body">
					<div class="form-group row">
						<textarea class="form-control" id="dietprefs" name="dietprefs" rows="3">{{ $post->dietprefs }}</textarea>
						@error('dietprefs') 
						<div class="alert alert-danger" role="alert">
							{{ $message }} 
						</div>
					...
					<div class="form-group row">
						<label for="shirtsize" class="col-md-6 col-form-label text-md-left">{{ __('Shirt Size') }} *</label>
							<div class="col-md-6">
								<select name="shirtsize">
								  <option value='S' @if($post->shirtsize == 'S') selected @endif>Small (S)</option>
								  <option value='M' @if($post->shirtsize == 'M') selected @endif>Medium (M)</option>
								  <option value='L' @if($post->shirtsize == 'L') selected @endif>Large (L)</option>
								  <option value='XL' @if($post->shirtsize == 'XL') selected @endif>Extra Large (XL)</option>
								  <option value='XXL' @if($post->shirtsize == 'XXL') selected @endif>Extra Extra Large (XXL)</option>
								  <option value='XXXL' @if($post->shirtsize == 'XXXL') selected @endif>Free Size (XXXL)</option>
								</select> 
								@error('shirtsize') 
									<div class="alert alert-danger" role="alert">
									{{ $message }} 
						...
						<label for="iccmelse" class="col-md-6 col-form-label text-md-left">{{ __('Have you ever visited an ICCM Conference elsewhere?:') }}</label>
							<div class="col-md-6">
								@error('iccmelse') 
									...
									@enderror
								<div class="form-check form-check-inline">
  									<input class="form-check-input @error('iccmelse') is-invalid @enderror" type="radio" name="iccmelse" id="iccmelse" value="no" @if($post->iccmelse == 'no') checked @endif>
								...
								<div class="form-check form-check-inline">
									...
									@enderror
  									<input class="form-check-input @error('iccmelse') is-invalid @enderror" type="radio" name="iccmelse" id="iccmelse" value="yes" @if($post->iccmelse == 'yes') checked @endif>
								    <label class="form-check-label" for="iccmelse">{{ __('Yes, my last ICCM was in (year):') }}</label>
								</div>
								
								    <input id="iccmelse_lastyear" type="text" class="form-control" name="iccmelse_lastyear" value="{{ $post->iccmelse_lastyear }}" autocomplete="iccmelse_lastyear" autofocus>
								    <label class="form-check-label" for="iccmlocation">{{ __('and located in:') }}</label>
								    <select name="iccmlocation">
										<option value='KENYA' @if($post->iccmlocation == 'KENYA') selected @endif>KENYA</option>
										<option value='BURKINA' @if($post->iccmlocation == 'BURKINA') selected @endif>FASO</option>
										<option value='USA' @if($post->iccmlocation == 'USA') selected @endif>USA</option>
										<option value='EUROPE' @if($post->iccmlocation == 'EUROPE') selected @endif>EUROPE</option>
										<option value='AUSTRALIA' @if($post->iccmlocation == 'AUSTRALIA') selected @endif>AUSTRALIA</option>
										<option value='ASIA' @if($post->iccmlocation == 'ASIA') selected @endif>ASIA</option>
										<option value='OTHER' @if($post->iccmlocation == 'OTHER') selected @endif>OTHER</option>
								    </select> 
								    @error('iccmlocation') 
										<div class="alert alert-danger" role="alert">
										{{ $message }} 
                     ...
                     <div class="form-group row">
						<label for="knowiccm" class="col-md-6 col-form-label text-md-left">
							...
							<div class="col-md-6">
								<textarea class="form-control" id="knowiccm" name="knowiccm" rows="3">{{ $post->knowiccm }}</textarea>
								@error('knowiccm') 
									<div class="alert alert-danger" role="alert">
									{{ $message }} 
									</div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        <div class="form-group row">
							...
							<p>
								...
								") }}
									...
									<p><i>{{ __("Privacy exception 3A: This will be listed on the attendee list under 'Talents'") }}</i></p>
							</label>
						</div>
						<div class="form-group row">
                            <div class="col-md-12">
								<textarea class="form-control" id="experince_itman" name="experince_itman" rows="3">{{ $post->experince_itman }}</textarea>
						...
						<div class="form-group row">
                            <div class="col-md-12">
								<textarea class="form-control" id="expert_itman" name="expert_itman" rows="3">{{ $post->expert_itman }}</textarea>
								@error('expert_itman') 
								<div class="alert alert-danger" role="alert">
									{{ $message }} 
								</div>
                        ...
                        <div class="form-group row">
                            <label for="learn_itman" class="col-md-12 col-form-label text-md-center"><p>{{ __("
								Can you describe (with keywords)
								The IT and/or management areas you would like to learn about at ICCM-Africa:
								") }}</p>
								<p><i>{{ __("
								Privacy exception 3B: This will be listed on the attendee list under 'Would like to learn about'
								") }}</i></p>
							</label>
						</div>
						<div class="form-group row">
                            <div class="col-md-12">
								<textarea class="form-control" id="learn_itman" name="learn_itman" rows="3">{{ $post->learn_itman }}</textarea>
								@error('learn_itman') 
									<div class="alert alert-danger" role="alert">
										{{ $message }} 
									</div>
						...
						<div class="form-group row">
                            <div class="col-md-12">
								<textarea class="form-control" id="tech_impl" name="tech_impl" rows="3">{{ $post->tech_impl }}</textarea>
								@error('tech_impl') 
									<div class="alert alert-danger" role="alert">
										{{ $message }} 
									</div>
						...
						<div class="form-group row">
                            <div class="col-md-12">
								<textarea class="form-control" id="new_tech" name="new_tech" rows="3">{{ $post->new_tech }}</textarea>
								@error('new_tech') 
									<div class="alert alert-danger" role="alert">
										{{ $message }} 
									</div>
						...
						<div class="form-group row">
                            <div class="col-md-12">
								<textarea class="form-control" id="help_worship" name="help_worship" rows="3">{{ $post->help_worship }}</textarea>
								@error('help_worship') 
									<div class="alert alert-danger" role="alert">
										{{ $message }} 
									</div>
						...
						<div class="form-group row">
                            <div class="col-md-12">
								<textarea class="form-control" id="speakers" name="speakers" rows="3">{{ $post->speakers }}</textarea>
								@error('speakers') 
									<div class="alert alert-danger" role="alert">
										{{ $message }} 
									</div>
						...
						<div class="form-group row">
                            <div class="col-md-12">
								<textarea class="form-control" id="speakers" name="help_iccm" rows="3">{{ $post->help_iccm }}</textarea>
								@error('help_iccm') 
									<div class="alert alert-danger" role="alert">
										{{ $message }} 
									</div>
