            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse " id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('schedule') }}">Schedule <span
                        ...
                        @php
                            $pages = App\DynamicPage::all();
                        @endphp
                        @foreach ($pages as $page)
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('showPage', $page->id) }}">{{ $page->menu_title }}</a>
                            </li>
                        @endforeach
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    @if (Auth::user()->role == 'admin')
                                        ...
                                        <a class="dropdown-item"
                                            href="{{ route('dynamicPages.index') }}">{{ __('Dynamic pages') }}</a>
                                    @endif
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-8 iccmfooter">
                    ICCM-Africa is being hosted by <a href="https://kingdomit.nl">KingdomIT Foundation</a>. See also our
                    <a href="{{ asset('pdf/privacy.pdf') }}">privacy policy</a>.
                </div>
            </div>
        </div>
