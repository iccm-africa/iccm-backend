...
@section('content')
    <div class="container">
        ...
        <div class="row pt-2">
            <div class="col-12">
                <form method="POST" action="{{ route('dynamicPages.update', $dynamicPage->id) }}">
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="htmlContent" name="html_content" rows="20" 
                        cols="100">{{ $dynamicPage->html_content }}</textarea>
                    </div>
